...
<body>
		<h3 style="width: 200px; height: 30px;">중고게시판</h3>
				...
				<div class="e-approval-search-bar">
					<form class="e-approval-search-form" action="/marketSelect" name="frm_market" method="post">
						<div class="e-approval-form-box">
							<input class="form-control form-control-sm" type="text" placeholder="상품명" aria-label="Search" id='findStr'  name='findStr'> 
							...
							<input class="btn btn-outline-primary btn-sm" type="submit" value="검색" /> 
						</div>
					</form>
				</div>
</body>
