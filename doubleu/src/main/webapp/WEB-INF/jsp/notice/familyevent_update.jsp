			    ...
			    <div class="col-xs-8 col-md-10">
				    <div class="table table-responsive">
				        ...
				        <tr>
				            ...
				            <td><input type="date" id="mdate" name="familyeventReportingDate" value="${obj.familyeventReportingDate }" readonly></td>
				            </div>
				        </tr>
				        <tr>
				        	...
				        	<td colspan="3" style="padding-left:8px;">
							    <div class="dropdown-align">
									<label for="familyeventPostType"></label>
										<input type="hidden" id="familyeventPostTypehidden" value="${obj.familyeventPostType }">
										<input type="radio" name="familyeventPostType" id="r1" value="영구"><label for="r1">영구 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
										<input type="radio" name="familyeventPostType" id="r2" value="설정"><label for="r2">설정  &nbsp;&nbsp;</label>
				        ...
				        <tr>
				        	<div class="form-group">
					            ...
					            <td colspan="3">
					            <textarea class="form-control" id="exampleFormControlTextarea1" rows="15" name="familyeventDoc">${obj.familyeventDoc }</textarea>
					            </td>
						  	</div>
				        </tr>
