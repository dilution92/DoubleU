		...
		<main>
			<div class="e-approval-form-workType-container">
				...
				<table class="table table-sm e-approval-form-table-3 table-bordered">
					<tr>
						<th> 품의 목적 </th>
						<td> <input type="text" value=" ${vo.formPetitionVo.formPurpose}" class="form-control form-control-sm approval-select-view" readonly="readonly"> </td>
						<th> 금액 </th>
						<td> <input type="text" value="${vo.formPetitionVo.budget }" class="form-control form-control-sm approval-select-view" readonly="readonly"> </td>
					</tr>
					<tr>
						<th> 제목 </th>
